...
viewPostList tags metadata selectedTag =
                ...
                Just _ ->
                    Route.Blog
                        |> Route.link
                            []
                            [ Html.h3
                                [ Attrs.class "text-gray-900 dark:text-gray-100 dark:hover:text-nord-12 font-bold uppercase"
                                ]
                                [ Html.text "All Posts" ]
                            ]
    ...
    , Html.div [ Attrs.class "flex sm:space-x-2 md:space-x-12" ]
        [ Html.div [ Attrs.class "hidden max-h-screen h-full sm:flex flex-wrap bg-gray-50 dark:bg-nord-1 shadow-md pt-5 dark:shadow-gray-800/40 rounded-sm min-w-[280px] max-w-[280px] overflow-auto" ]
            [ Html.div
                        ...
                        (\tag ->
                            Html.li
                                ...
                                [ Route.Tags__Slug_ { slug = tag.slug }
                                    |> Route.link
                                        [ Attrs.class "py-2 px-3 uppercase text-sm font-medium text-gray-500 dark:text-gray-300 dark:hover:text-nord-12 dark:hover:text-primary-500"
